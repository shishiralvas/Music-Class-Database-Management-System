 ...
 * @author Shishir Alva
 */
public class Competetion extends javax.swing.JFrame {

    /**
     * Creates new form Competetion
     */
    public Competetion() {
        initComponents();
        try{
            ...
            ResultSet rs=st.executeQuery("select max(id) from competetion");
            while(rs.next())
            {
                id=rs.getInt(1);
                id=id+1;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Competetions");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Competetion ID:");
        ...
        jLabel10.setText("Competetion Name");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Guitar", "Fusion", "Sitar", "Orchestra" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String competetionname=(String)jComboBox2.getSelectedItem();
        //String aadharnumber=jTextField6.getText();
        String age=jTextField7.getText();
        String entryfee=jTextField8.getText();
        try{
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("insert into competetion values(?,?,?,?,?,?,?,?)");
            ps.setString(1,id);
            ps.setString(2,name);
          ...
          //  ps.setString(7,mothername);
            ps.setString(6,competetionname);
          //  ps.setString(9,aadharnumber);
            ps.setString(7,age);
            ps.setString(8,entryfee);
            ps.execute();
