  ...
  public void tableDetails()
    {
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select *from practice where id='"+id+"'");
            while(rs.next())
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs1 = st.executeQuery("select *from practice inner join member where practice.month='"+month+"'and practice.id='"+id+"'and member.id='"+id+"'");
            while(rs1.next())
            {
